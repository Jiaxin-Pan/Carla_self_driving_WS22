...
def save_to_list(image,frame,p,k):
    #print("here", frame)
    img = logistic_depth(image)
    global image_list
    image_list[frame,p,:,:] = img *k
...
def main():
    ...
    try:
        ...
        camera.listen(lambda image: save_to_list(image,frame,1,1))
        camera_left.listen(lambda image: save_to_list(image,frame,0,0.5))
        camera_right.listen(lambda image: save_to_list(image,frame,2,0.5))
