...
def main():
    ...
    try:
        ...
        camera.listen(lambda image: image.save_to_disk('3_cameras/Dataset013_middle/%06d.png' % frame, cc) if frame>40 else None)
        camera_left.listen(lambda image: image.save_to_disk('3_cameras/Dataset013_left/%06d.png' % frame, cc) if frame>40 else None)
        camera_right.listen(lambda image: image.save_to_disk('3_cameras/Dataset013_right/%06d.png' % frame, cc) if frame>40 else None)
        ...
        for frame in range(251):
            ...
            if frame>40:
                steer_list = np.append(steer_list, vehicle.get_control().steer)
        ...
        f = open("./3_cameras/steerings/steer013.py","a")
        f.write(str(repr(steer_list)))
